...
const profile = () => {
  ...
  const loadUserData = async () => {
    try {
      const { firstName, lastName, email, phone, preferences, avatar } =
        Object.fromEntries(
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.avatarContainer}>
          <Avatar big={true} avatar={avatar} />
          <Button
            onPress={() => {
              setAvatar('../assets/images/Profile.png');
            }}
            mode={'contained'}
          >
            {' '}
        ...
        <Checkbox.Item
          ...
          status={preferences.orderStatuses ? 'checked' : 'unchecked'}
          onPress={() => {
        ...
        <Checkbox.Item
          ...
          status={preferences.passwordChanges ? 'checked' : 'unchecked'}
          onPress={() => {
            setPreferences(prevState => {
              return {
                ...prevState,
        ...
        <Checkbox.Item
          ...
          status={preferences.specialOffers ? 'checked' : 'unchecked'}
          onPress={() => {
            setPreferences(prevState => {
              return {
                ...prevState,
        ...
        <Checkbox.Item
          label={'Newsletter'}
          status={preferences.newsletter ? 'checked' : 'unchecked'}
          onPress={() => {
            setPreferences(prevState => {
              return {
                ...prevState,
      ...
      <View style={styles.containerFooter}>
        <Button mode="outlined" onPress={loadUserData}>
          Discard changes
        </Button>

        <Button mode="contained" onPress={saveUserData}>
          Save changes
        </Button>
      </View>
    </View>
